#include <iostream>
//En este programa crearemos un programa el cual tiene como función evaluar la sumatoria a partir de un metodo iterativo, recursivo y directo matematico
...
int main (){
    ...
    int eleccion;
    while(menu){
        cout<<"Ingresa 1 para calcular la sumatoria con el numero que tu ingreses"<<endl;
